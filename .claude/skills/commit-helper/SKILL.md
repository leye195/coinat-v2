...
2. 현재 브랜치 확인
   - 만약 현재 브랜치가 `develop`, `main`, `master` 중 하나라면, 작업 내용에 맞는 적절한 새 브랜치명을 생성하여 브랜치를 이동합니다 (`git checkout -b <new-branch-name>`).
...
Implement social login using Google OAuth 2.0.
- Implement login/logout flows
- Integrate user profile information
